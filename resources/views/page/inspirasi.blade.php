      ...
      <div class="row g-1">
        ...
        <div class="col-4">
          <div class="card shadow-sm" style="width: 20em">
            <img class="bd-placeholder-img card-img-top p-2" width="100" height="200" src="{{$ins['gambar']}}">
            <div class="card-body">
            	<h5 class="card-title">{{$ins['ket']}}</h5>
              	<a class="card-text" href="/single-ins">Baca Selengkapnya...</a>              
            </div>
          </div>
        </div>
      	@endforeach
