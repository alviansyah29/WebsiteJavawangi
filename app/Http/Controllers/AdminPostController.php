...
class AdminPostController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       Bisnis::create($data);
       return redirect('/admin/bisnis')->with('sukses','Data Produk Berhasil Ditambahkan!');
    }
    ...
    public function update(Request $request, Bisnis $bisni)
    {
       ...
       return redirect('/admin/bisnis')->with('sukses','Data Produk Berhasil Diubah!');
    }
    ...
    public function destroy(Bisnis $bisni)
    {
       ...
       return redirect('/admin/bisnis')->with('sukses','Data Produk Berhasil Dihapus!');
    }
